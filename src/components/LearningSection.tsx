      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Continuous growth and skill development in backend technologies, 
            with a focus on practical application and real-world problem solving.
          </p>
        </div>
              ...
              {currentLearning.map((item, index) => (
                ...
                >
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h4 className="font-semibold text-foreground flex-1">{item.title}</h4>
              ...
              {futureGoals.map((goal, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-foreground font-medium leading-relaxed">{goal}</p>
                  </div>
                </Card>
              ))}
            </div>
            ...
            <Card className="mt-8 p-6 bg-tech-gradient text-white">
              <blockquote className="text-center">
                <p className="text-lg font-medium mb-2">
                  ...
                  in key areas of software engineering and product management."
                </p>
                <footer className="text-sm opacity-90">— Personal Learning Philosophy</footer>
              </blockquote>
            </Card>
          </div>
        </div>
