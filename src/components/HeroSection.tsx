  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-hero-gradient">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-3/4 right-1/4 w-24 h-24 bg-tech-purple rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-1/4 left-1/2 w-40 h-40 bg-primary rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }} />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fadeInUp">
            ...
            <p className="text-lg text-foreground/80 mb-12 max-w-2xl">
              Precision & clarity in code. Committed to mastering the .NET ecosystem 
            ...
            <div className="flex gap-4 justify-center lg:justify-start">
              <Button variant="ghost" size="icon" asChild>
                <a href="https://linkedin.com/in/nour-el-deen-mahmoud/" target="_blank" rel="noopener noreferrer">
                  <Linkedin className="w-5 h-5" />
                </a>
              </Button>
              <Button variant="ghost" size="icon" asChild>
                <a href="https://wa.me/+201143971233" target="_blank" rel="noopener noreferrer">
          ...
          <div className="flex justify-center animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-tech-purple rounded-full opacity-40 animate-float" style={{ animationDelay: '1s' }} />
            </div>
          </div>
        </div>
      </div>
