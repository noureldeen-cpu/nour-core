            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                        A comprehensive set of modern technologies and
                        frameworks that power robust backend solutions and
                ...
                <div className="mt-16 text-center">
                    <Card className="inline-block p-6 bg-tech-gradient-subtle border-primary/20">
                        <p className="text-muted-foreground">
                            ...
                            Strong communication and product ownership
                            capabilities, including backlog management and user
                            story creation.
                        </p>
                    </Card>
                </div>
