            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                        ...
                        backend challenges? I'm always open to new opportunities
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                    {contactMethods.map((method, index) => (
                        ...
                        >
                            ...
                            >
                                <div
                                    className={`w-12 h-12 ${method.color} rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 text-white`}
                                >
                                    {method.icon}
                                </div>
                ...
                <Card className="max-w-4xl mx-auto p-8 bg-tech-gradient text-white text-center">
                    ...
                    <p className="text-lg mb-6 opacity-90">
                        Whether you have a challenging backend project, need
                        technical consultation, or want to discuss the latest in
                        .NET development, I'm here to help.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button
                            size="lg"
