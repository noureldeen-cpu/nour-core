            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                        As a dedicated backend developer, I am committed to
                        mastering the .NET ecosystem with structured thinking
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        My approach is rooted in structured
                                        thinking, ensuring clean code and
                                        logical problem-solving. I excel at
                        ...
                        <Card className="p-8 bg-card/50 backdrop-blur-sm border-primary/20 hover:border-primary/40 transition-all duration-300">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        My passion for Formula 1 mirrors my
                                        professional ethos: precision, control,
                                        and unwavering focus. This drives my
                                        pursuit of robust and maintainable
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        ...
                                        capabilities, including backlog
