...
const experiences = [
    {
        ...
        description:
            "Product Owner trainee focused on backlog management, user story creation, and feature prioritization. Duration: July 1 to end of August 2024.",
        highlights: [
            "Backlog management",
            "User story creation",
    ...
    },
    {
        ...
        description:
            "Backend developer specializing in .NET development, applying clean architecture principles and best practices to build scalable solutions.",
        highlights: [
            ".NET development",
            "Clean architecture",
            "API development",
    ...
    },
    {
        ...
        description:
            "Involved in various initiatives focused on teaching, mentoring, and fostering team collaboration. This experience has honed my ability to explain complex technical concepts clearly and work effectively within diverse groups.",
        highlights: [
            "Technical mentoring",
            "Team collaboration",
            "Knowledge sharing",
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                        Hands-on experience in backend development, product
                        ownership, and community engagement that shaped my
